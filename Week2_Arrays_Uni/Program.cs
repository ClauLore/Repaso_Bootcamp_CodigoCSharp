    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            Console.WriteLine("=========================\n");
            Console.WriteLine("1. Calcular el promedio de calificaciones\n");
            Console.WriteLine("2. Encontrar la calificación más alta y la más baja\n");
            Console.WriteLine("3. Calcular cuántos estudiantes aprobaron (calificación >= 60)\n");
            Console.WriteLine("4. Mostrar las calificaciones en orden ascendente\n");
            Console.WriteLine("5. Mostrar cuántos estudiantes obtuvieron calificaciones por rangos\n");

            Console.WriteLine("Ingresar calificaciones :\n");
            ...
            int opcion;
            Console.WriteLine("Ingresar una opción del menú :\n");
            ...
            switch (opcion)
            {
                case 1:
                    ...
                    break;
                case 2:
                    CalificacionMaxMin(calificaciones);
                    break;
                case 3:
        ...
        private static void MostrarDistribucionRangos(double[] calificaciones)
        {
            ...
            for (int i = 0; i < calificaciones.Length; i++)
            {
                ...
                else if (calificaciones[i] >= 60 && calificaciones[i] <= 69)
                {
                    suficiente++;
                }
                else if (calificaciones[i] >= 70 && calificaciones[i] <= 79)
                {
                    bien++;
                }
            ...
            Console.WriteLine($"Suficiente : {suficiente}");
            Console.WriteLine($"Bien : {bien}");
            Console.WriteLine($"Notable : {notable}");
        ...
        private static void CalificacionMaxMin (double[] calificaciones)
        {
            ...
            Console.WriteLine("Calificación máxima " + calificaciones[9]);
        }
